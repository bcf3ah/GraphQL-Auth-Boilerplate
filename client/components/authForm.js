...
class AuthForm extends Component {
	...
	onSubmit(event){
		...
		this.props.onSubmit(this.state); //same name for functions from signupForm and loginForm because two forms are rendering the same AuthForm component, and passing down different mutations under the same name.
	}
